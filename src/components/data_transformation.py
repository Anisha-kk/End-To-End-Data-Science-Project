...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        try:
            ...
            logging.info("Column encoding completed")
    ...
    def initiate_data_transformation(self,train_path,test_path):
        try:
            ...
            logging.info("Completed reading train and test datasets")
            logging.info("Obtaining Preprocessing object")

            preprocessing_obj = self.get_data_transformer_object()

            target_column_name = "math_score"#Refer the jupyter notebooks
            ...
            train_arr = np.c_[input_feature_train_arr,np.array(target_feature_train_df)] #Concatenation along second axis
            test_arr = np.c_[input_feature_test_arr,np.array(target_feature_test_df)]

            logging.info("Saved preprocessing task")
